  ...
  const actions = [
    {
      ...
      icon: (
        <svg className="w-5 h-5 text-[#8f7bf0]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="pointer-events-auto absolute left-1/2 bottom-6 z-20 flex -translate-x-1/2 items-center gap-6 select-none">
      {actions.map((act) => (
        ...
        >
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-[#8f7bf0]/20 bg-black/40 shadow-[0_10px_30px_-12px_rgba(0,0,0,0.8)] backdrop-blur-md transition-all group-hover:border-[#8f7bf0]/70 group-hover:bg-[#8f7bf0]/10 group-hover:shadow-[0_0_22px_-4px_rgba(139,124,240,0.6)]">
            {act.icon}
          </div>
          <span className="font-data text-[10px] font-semibold tracking-wider text-foam/90 group-hover:text-[#c4b9ff]">
            {act.title}
          </span>
