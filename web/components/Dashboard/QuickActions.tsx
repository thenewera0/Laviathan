...
export default function QuickActions({
  ...
  const actions = [
    {
      ...
      icon: (
        <svg className="w-5 h-5 core-lit" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    ...
    <div style={{ "--d": "530ms" } as React.CSSProperties} className="deck-in-center pointer-events-auto absolute left-1/2 bottom-5 z-20 -translate-x-1/2 select-none">
