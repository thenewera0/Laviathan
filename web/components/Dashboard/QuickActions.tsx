  ...
  return (
    <div className="pointer-events-auto absolute left-1/2 bottom-5 z-20 flex -translate-x-1/2 items-center gap-6 select-none">
      {actions.map((act) => (
        ...
        >
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/20 bg-[#080d1c]/90 shadow-[0_10px_30px_rgba(0,0,0,0.8)] backdrop-blur-xl transition-all duration-300 group-hover:border-[#00d4ff] group-hover:bg-gradient-to-br group-hover:from-[#00d4ff]/20 group-hover:to-[#f59e0b]/20 group-hover:shadow-[0_0_25px_rgba(0,212,255,0.6)]">
            {act.icon}
          </div>
          <span className="font-data text-[10px] font-bold tracking-wider text-white group-hover:text-[#00d4ff] transition-colors">
            {act.title}
          </span>
