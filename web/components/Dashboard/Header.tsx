  ...
  return (
    <header className="pointer-events-auto absolute left-0 right-0 top-0 z-20 flex items-center justify-between px-8 py-6 select-none">
      ...
      <div className="flex flex-col items-center gap-1.5">
        ...
        <div className="flex items-center gap-2 font-data text-xs text-[#7dd3fc]/90">
          ...
          <div className="flex h-3 items-center gap-0.5">
            ...
            <span className="h-3 w-0.5 animate-pulse rounded-full bg-[#38bdf8] delay-75" />
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2 rounded-full border border-[#38bdf8]/30 bg-black/40 px-3.5 py-1.5 shadow-[0_0_20px_-6px_rgba(56,189,248,0.6)] backdrop-blur-md">
          <svg className="h-3.5 w-3.5 text-[#38bdf8]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
